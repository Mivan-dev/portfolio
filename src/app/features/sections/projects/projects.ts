...
export class Projects {
  projects = [
    ...
    },
    {
      ...
      description:
        'Aplicación personal para llevar gastos de tarjetas de crédito y servicios con guardado en LocalStorage. Proximamente con db propia en PostgreSQL y NestJS.',
